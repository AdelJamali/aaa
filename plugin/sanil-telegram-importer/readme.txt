== 10.11-UX ==
* UX PILOT — Golden Scan is now a Premium SaaS Operations Console (Persian, RTL, mobile-first). Presentation layer only: zero changes to business logic, state machine, worker, governor, queues, Telegram, AJAX contracts (every action/param/nonce verified identical), capability checks or `gs_view` deep links. «ظاهر کاملاً جدید. موتور کاملاً محفوظ.»
...
* Docs: DESIGN-10.11-UX.md. Regression: P0 6/6 + 10.11 suite 45/45 still PASS; ZIP shipped after host runtime acceptance.
