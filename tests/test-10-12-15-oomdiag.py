...
check('V1 version 10.12.22', "define( 'STI_VERSION', '10.12.22' )" in main and 'Version:           10.12.22' in main)
...
check('O10 OOM_DIAG logged at client() failure (10.12.22: safe wrapper + gate probe)',
