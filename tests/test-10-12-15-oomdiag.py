...
check('V1 version 10.12.21', "define( 'STI_VERSION', '10.12.21' )" in main and 'Version:           10.12.21' in main)
...
check('O10 OOM_DIAG logged at client() failure (10.12.21: safe wrapper + gate probe)',
