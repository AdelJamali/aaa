...
check('V1 version 10.12.17', "define( 'STI_VERSION', '10.12.17' )" in main and 'Version:           10.12.17' in main)
...
check('O10 OOM_DIAG logged at client() failure (10.12.17: safe wrapper + gate probe)',
