#!/usr/bin/env python3
"""10.12.20 — diagnostic-only patch. Static verification of each RULE.
...
check('V1 version 10.12.20',
      "define( 'STI_VERSION', '10.12.20' )" in main and 'Version:           10.12.20' in main)
...
# ---------- 10.12.20 Stage 1: diagnostic must never emit a warning ----------
...
# ---------- 10.12.20 Stage 2: required measurements ----------
...
# ---------- 10.12.20 Stage 3: evidence preserved separately ----------
...
print('10.12.20 DIAGNOSTIC-PATCH SUITE: ALL PASS')
